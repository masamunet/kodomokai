...
export function ForumDetailScreen({ question, user, handleSubmitAnswer }: Props) {
  return (
    <Box className="max-w-4xl mx-auto pb-32">
      <Box className="mb-6">
        <Button variant="ghost" asChild className="pl-0 hover:bg-transparent hover:text-primary gap-2" activeScale={true}>
          <Link href="/forum">
            <ArrowLeft size={20} />
            <Text weight="bold">一覧に戻る</Text>
          </Link>
        </Button>
      </Box>
