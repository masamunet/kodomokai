...
export default function AccountingEditor({ initialData, currentYear, accountingInfo, readOnly = false }: Props) {
  ...
  return (
    <>
      ...
      {/* Print Layout */}
      <div className={`${readOnly ? '' : 'hidden print:block'} font-serif text-black p-4 max-w-[210mm] mx-auto bg-white shadow-sm rounded-xl`}>
